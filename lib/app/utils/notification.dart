...
class NotificationSetUp {
  ...
  Future<void> initializeNotification() async {
    AwesomeNotifications().initialize('resource://drawable/app_logo', [
      NotificationChannel(
...
class NotificationController {
  ...
  static Future<void> onNotificationCreatedMethod(
    ...
    if (receivedNotification.payload != null) {
      ...
      print(
          'Notification payload: ${receivedNotification.payload} ${receivedNotification.actionType}');
    }
    // if (receivedNotification.actionType == ActionType.Default) {
  ...
  static Future<void> onActionReceivedMethod(
      ReceivedAction receivedAction) async {
    print('It worksz ${receivedAction.buttonKeyPressed} ok');
    if (receivedAction.buttonKeyPressed == 'View 1') {
      Get.toNamed(AppPages.USER_HISTORY);
    } else {
      print('Cancel');
    }
